...
class _DriverStudentsTabState extends State<DriverStudentsTab> {
  ...
  /// Reinicia os streams quando a sala ativa muda.
  void _onViewModelChanged() {
    ...
    if (newSalaId != _currentSalaId) {
      ...
      _studentsSub = null;
      _attendanceSub = null;
      if (mounted) setState(() { _students = []; _votes = {}; });
      if (_salaId.isNotEmpty) _startStreams();
    }
  }
        ...
        Expanded(child: filtered.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                final status = vote?['status'] as String?;
                final liberado = vote?['liberado'] == true;
                // Prefere a faculdade da chamada do dia; se o aluno ainda não
                // confirmou, usa a faculdade gravada no cadastro dele na sala.
                final faculdade = (vote?['faculdadeName'] as String?) ?? (s['faculdadeName'] as String?);
